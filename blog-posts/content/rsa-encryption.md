...
In our example there were only 76 possible messages. In the real world we usually ensure there are **2²⁰⁴⁸** possible messages — a 617-digit number. Just for fun, here is 2²⁰⁴⁸ written out in plain English. The scrollable box is intentional.
