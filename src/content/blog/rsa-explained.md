...
summary: "The best way to measure understanding of a topic is to explain it as clearly and simply as possible. This is my explanation of the RSA algorithm, and all the math behind it, at as low a technical level as possible."
references:
  - { label: "Wikipedia — RSA Cryptosystem", url: "https://en.wikipedia.org/wiki/RSA_(cryptosystem)" }
  - { label: "Wikipedia — Public-Key Cryptography", url: "https://en.wikipedia.org/wiki/Public-key_cryptography" }
  - { label: "Wikipedia — Modular Arithmetic", url: "https://en.wikipedia.org/wiki/Modular_arithmetic" }
  - { label: "Wikipedia — Carmichael Function", url: "https://en.wikipedia.org/wiki/Carmichael_function" }
  - { label: "Wikipedia — Coprime Integers", url: "https://en.wikipedia.org/wiki/Coprime_integers" }
  - { label: "Wikipedia — Modular Multiplicative Inverse", url: "https://en.wikipedia.org/wiki/Modular_multiplicative_inverse" }
  - { label: "Wikipedia — Extended Euclidean Algorithm", url: "https://en.wikipedia.org/wiki/Extended_Euclidean_algorithm" }
  - { label: "Wikipedia — Bézout's Identity", url: "https://en.wikipedia.org/wiki/B%C3%A9zout%27s_identity" }
  - { label: "Wikipedia — Euler's Totient Function", url: "https://en.wikipedia.org/wiki/Euler%27s_totient_function" }
---
